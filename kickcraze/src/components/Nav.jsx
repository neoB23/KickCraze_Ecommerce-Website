...
function Nav() {
  ...
  return (
    <div className="flex justify-between items-center p-2 ml-12">
      <CustomLink href="/"> <img src="images/logo.png" className="w-16 h-16 object-contain" alt="logo"/> </CustomLink>
      <div className="flex gap-x-5 mr-12">     
        ...
        <CustomLink href="/">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path fill="black" d="M19 7h-3V6a4 4 0 0 0-8 0v1H5a1 1 0 0 0-1 1v11a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V8a1 1 0 0 0-1-1m-9-1a2 2 0 0 1 4 0v1h-4Zm8 13a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V9h2v1a1 1 0 0 0 2 0V9h4v1a1 1 0 0 0 2 0V9h2Z"/>
          </svg>
        </CustomLink>
      </div>
    </div>
